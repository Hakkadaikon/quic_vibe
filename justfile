...
build:
    mkdir -p build
    {{cc}} {{cflags}} -c src/sys/sys.c src/varint/varint.c src/packet/header.c src/packet/pnum.c src/tparam/tparam.c src/frame/frame.c src/fsm/fsm.c src/stream/stream.c src/conn/conn.c src/hash/sha256.c
    mv *.o build/
