...
static int names_chain(const u8 *child, usz child_len,
                       const u8 *parent, usz parent_len)
{
    const u8 *iss, *subj;
...
static int link_ok(const u8 *child, usz child_len,
                   const u8 *parent, usz parent_len)
{
...
int quic_castore_validate_chain(const quic_castore *s,
                                const u8 *const *certs, const usz *cert_lens,
                                usz n_certs)
{
