...
static void clock_civil(u64 days, u64 *y, u64 *m, u64 *d) {
...
u64 quic_clock_epoch_to_ymdhms(u64 secs) {
  u64 days = secs / 86400, rem = secs % 86400, y, m, d;
  clock_civil(days, &y, &m, &d);
  return ((y * 100 + m) * 100 + d) * 1000000 + (rem / 3600) * 10000 +
