...
static int past_threshold(const quic_sentpkt_entry *p, u64 largest_acked,
                          u64 now, u64 loss_delay)
{
...
static int loss_is_lost(const quic_sentpkt *t, usz i, u64 largest_acked, u64 now,
                        u64 loss_delay)
{
    return inflight(t, i) &&
