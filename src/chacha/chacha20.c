...
void quic_chacha20_block(const u8 key[QUIC_CHACHA_KEY], u32 counter,
...
static usz xor_chunk(const u8 *key, u32 counter, const u8 *nonce,
...
void quic_chacha20_xor(const u8 key[QUIC_CHACHA_KEY], u32 counter,
                       const u8 nonce[QUIC_CHACHA_NONCE],
